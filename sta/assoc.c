...
#ifdef DOT11_N_SUPPORT
    //Added by Eddy
    if ((pAd->CommonCfg.PhyMode != pAd->StaCfg.CfgPhyMode)
        && (pAd->StaCfg.CfgPhyMode >= PHY_11ABGN_MIXED)) {
        pAd->CommonCfg.PhyMode = pAd->StaCfg.CfgPhyMode;
        pAd->CommonCfg.DesiredPhyMode = pAd->CommonCfg.PhyMode;
